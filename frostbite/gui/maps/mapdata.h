...
public:
    ...
    QString findPath(QString startZoneId, int startId, QString destZoneId, int destId);
    QString findPathDetailed(QString startZoneId, int startId, QString destZoneId, int destId,
